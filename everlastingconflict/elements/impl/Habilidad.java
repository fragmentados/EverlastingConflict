...
import static everlastingconflict.elements.impl.HabilitySelectionType.*;
...
public class Habilidad extends ElementoSimple {
    ...
    public ElementoComplejo targetSelection(Game p, ElementoComplejo origen, float x, float y) {
    ...
    public void activacion(Game p, ElementoComplejo origen) {
    ...
    public void resolucion(Game p, ElementoComplejo origen, ElementoVulnerable objetivo) {
        Bestia bestia;
        ...
        if (coste > 0) {
            ...
            switch (nombre) {
                ...
                case "Eclipse Amanecer":
                    ...
                    if (RelojMaestros.tiempo.equals(RelojMaestros.nombre_dia)) {
                        relojMaestros.cambio_temporal(RelojMaestros.nombre_noche);
                    } else {
                        relojMaestros.cambio_temporal(RelojMaestros.nombre_dia);
                    }
                    break;
                case "Meditar":
