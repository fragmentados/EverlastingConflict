...
public class WindowMenuPlayerSelection extends WindowMenuBasic {
    ...
    public void start(GameContainer container) {
        try {
            ...
            Partida partida = new Partida(players, MapEnum.findByName(mapCombo.optionSelected.text),
                    GameModeEnum.findByLabel(WindowMenuPlayerSelection.gameModeCombo.optionSelected.text));
            WindowMain.windowSwitch(container, partida, "Combat");
    ...
    public void update(GameContainer container, int delta) throws SlickException {
        ...
        if (input.isMousePressed(Input.MOUSE_LEFT_BUTTON)) {
            ...
            playerSelections.stream().forEach(p -> p.update(input, playerSelections));
