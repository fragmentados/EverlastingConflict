...
public class WindowMenu extends WindowMenuBasic {
    ...
    public void init(GameContainer container) throws SlickException {
        ...
        challenge = new BotonSimple("Desafios", WindowCombat.responsiveX(45), WindowCombat.responsiveY(60));
        changelog = new BotonSimple("Changelog", WindowCombat.responsiveX(45), WindowCombat.responsiveY(70));
    ...
    public void start(GameContainer container) {
        try {
            WindowMain.windowSwitch(container,
                    Tutorial.createTutorialByRace(raceTutorial.optionSelected.text),
                    "Combat");
    ...
    public void render(GameContainer container, Graphics g) throws SlickException {
        ...
        combate.render(g);
        tutorial.render(g);
        g.drawString("Nuevo!", changelog.x + changelog.anchura - "Nuevo!".length() * 8, changelog.y - 16);
        challenge.render(g);
        changelog.render(g);
        salir.render(g);
        volver.render(g);
        ...
        if (tutorialMode) {
            ...
            g.drawString(Partida.anadir_saltos_de_linea(RaceEnum.raceEnumMap.get(raceTutorial.optionSelected.text).getDescription(), 500), WindowCombat.responsiveX(50), WindowCombat.responsiveY(50));
